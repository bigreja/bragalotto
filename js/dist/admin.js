...
var EventsTab = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
    ...
    }), app.translator.trans('huseyinfiliz-pickem.admin.events.title')), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
    ...
    }, app.translator.trans('huseyinfiliz-pickem.admin.events.create'))), m("div", {
      className: "EventsTab-filters"
    }, m("div", {
      className: "FilterGroup"
    }, m("label", null, m("i", {
      className: "fas fa-calendar-alt"
    }), m("span", null, app.translator.trans('huseyinfiliz-pickem.admin.filters.season'))), m("select", {
      ...
      value: "all"
    }, app.translator.trans('huseyinfiliz-pickem.admin.filters.all_seasons')), allSeasons.map(function (season) {
      return m("option", {
        value: season.id(),
        key: season.id()
      }, season.name());
    ...
    }), m("span", null, app.translator.trans('huseyinfiliz-pickem.admin.filters.team'))), m("select", {
      className: "FormControl",
      ...
      value: "all"
    }, app.translator.trans('huseyinfiliz-pickem.admin.filters.all_teams')), allTeams.map(function (team) {
      return m("option", {
        value: team.id(),
        key: team.id()
      }, team.name());
    ...
    }), m("span", null, app.translator.trans('huseyinfiliz-pickem.admin.filters.status'))), m("select", {
      className: "FormControl",
      ...
      value: "all"
    }, app.translator.trans('huseyinfiliz-pickem.admin.filters.all_statuses')), m("option", {
      value: "scheduled"
    }, app.translator.trans('huseyinfiliz-pickem.admin.status.scheduled')), m("option", {
      value: "closed"
    }, app.translator.trans('huseyinfiliz-pickem.admin.status.closed')), m("option", {
      value: "finished"
    }, app.translator.trans('huseyinfiliz-pickem.admin.status.finished')))), m("div", {
      className: "FilterGroup"
    }, m("label", null, m("i", {
      className: "fas fa-sort"
    }), m("span", null, app.translator.trans('huseyinfiliz-pickem.admin.filters.sort'))), m("select", {
      className: "FormControl",
      ...
      value: "desc"
    }, app.translator.trans('huseyinfiliz-pickem.admin.filters.newest_first')), m("option", {
      value: "asc"
    }, app.translator.trans('huseyinfiliz-pickem.admin.filters.oldest_first')))), (this.selectedSeason !== 'all' || this.selectedTeam !== 'all' || this.selectedStatus !== 'all' || this.sortOrder !== 'desc') && m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
    ...
    }, app.translator.trans('huseyinfiliz-pickem.admin.filters.reset'))), this.loading ? m((flarum_common_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_3___default()), null) : !hasEvents ? m((flarum_common_components_Placeholder__WEBPACK_IMPORTED_MODULE_4___default()), {
      text: app.translator.trans('huseyinfiliz-pickem.admin.filters.no_matches_found')
    }) : m("table", {
      className: "Table"
    }, m("thead", null, m("tr", null, m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.events.home_team')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.events.away_team')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.events.match_date')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.events.status')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.events.score')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.buttons.actions')))), m("tbody", null, this.events.map(function (event) {
      ...
      }, event.status())), m("td", null, event.homeScore() !== null && event.awayScore() !== null ? event.homeScore() + " - " + event.awayScore() : '-'), m("td", null, m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
        className: "Button Button--primary",
        icon: "fas fa-edit",
        onclick: function onclick() {
          return app.modal.show(_modals_EventModal__WEBPACK_IMPORTED_MODULE_5__["default"], {
      ...
      }, app.translator.trans('huseyinfiliz-pickem.admin.buttons.edit')), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
      ...
      }, app.translator.trans('huseyinfiliz-pickem.admin.events.enter_result')), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
    ...
    }, app.translator.trans('huseyinfiliz-pickem.admin.pagination.previous')), m("span", {
...
var PickemPage = /*#__PURE__*/function (_ExtensionPage) {
  ...
  _proto.content = function content() {
    ...
    if (this.loading) {
      ...
      }, m((flarum_common_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_4___default()), null), m("p", null, "Loading data..."));
    } else if (this.error) {
    ...
    }, this.renderTab('events', 'fas fa-futbol', app.translator.trans('huseyinfiliz-pickem.admin.nav.events')), this.renderTab('teams', 'fas fa-users', app.translator.trans('huseyinfiliz-pickem.admin.nav.teams')), this.renderTab('seasons', 'fas fa-calendar-alt', app.translator.trans('huseyinfiliz-pickem.admin.nav.seasons')), this.renderTab('weeks', 'fas fa-calendar-week', app.translator.trans('huseyinfiliz-pickem.admin.nav.weeks')), this.renderTab('settings', 'fas fa-cogs', app.translator.trans('huseyinfiliz-pickem.admin.nav.settings'))), m("div", {
...
var SeasonsTab = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      className: "fas fa-calendar-alt"
    }), app.translator.trans('huseyinfiliz-pickem.admin.seasons.title')), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
      className: "Button Button--primary",
      icon: "fas fa-plus",
      onclick: function onclick() {
    ...
    }, app.translator.trans('huseyinfiliz-pickem.admin.seasons.create'))), m("table", {
      className: "Table"
    }, m("thead", null, m("tr", null, m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.seasons.name')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.seasons.slug')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.seasons.dates')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.buttons.actions')))), m("tbody", null, seasons.map(function (season) {
      return m("tr", {
        key: season.id()
        ...
        onclick: function onclick() {
          return app.modal.show(_modals_SeasonModal__WEBPACK_IMPORTED_MODULE_3__["default"], {
            ...
            onsave: function onsave() {
              return m.redraw();
            } // Düzenledikten sonra listeyi yenile
          });
        }
      }, app.translator.trans('huseyinfiliz-pickem.admin.buttons.edit')), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
        className: "Button Button--danger",
...
var SettingsTab = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }), app.translator.trans('huseyinfiliz-pickem.admin.settings.title')), m("p", null, app.translator.trans('huseyinfiliz-pickem.admin.settings.recalculate_scores_help')), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
      className: "Button Button--primary",
      icon: "fas fa-sync",
  ...
  _proto.recalculateScores = function recalculateScores() {
    ...
    app.request({
      ...
      app.alerts.show({
        type: 'success'
      }, app.translator.trans('huseyinfiliz-pickem.admin.settings.recalculate_scores_success'));
    })["catch"](function (error) {
      _this2.loading = false;
      m.redraw();
      app.alerts.show({
        type: 'error'
      }, app.translator.trans('huseyinfiliz-pickem.admin.settings.recalculate_scores_fail'));
      console.error(error);
    });
  };
  return SettingsTab;
...
var TeamsTab = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      className: "fas fa-users"
    }), app.translator.trans('huseyinfiliz-pickem.admin.teams.title')), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
      className: "Button Button--primary",
      icon: "fas fa-plus",
      onclick: function onclick() {
    ...
    }, app.translator.trans('huseyinfiliz-pickem.admin.teams.create'))), m("table", {
      className: "Table"
    }, m("thead", null, m("tr", null, m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.teams.logo')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.teams.name')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.teams.slug')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.buttons.actions')))), m("tbody", null, teams.map(function (team) {
      return m("tr", {
        key: team.id()
...
var WeeksTab = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }), app.translator.trans('huseyinfiliz-pickem.admin.weeks.title')), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
      className: "Button Button--primary",
      icon: "fas fa-plus",
      onclick: function onclick() {
    ...
    }, app.translator.trans('huseyinfiliz-pickem.admin.weeks.create'))), m("table", {
      className: "Table"
    }, m("thead", null, m("tr", null, m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.weeks.name')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.weeks.season')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.weeks.week_number')), m("th", null, app.translator.trans('huseyinfiliz-pickem.admin.buttons.actions')))), m("tbody", null, weeks.map(function (week) {
...
var EventModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.title = function title() {
    return app.translator.trans(this.event ? 'huseyinfiliz-pickem.admin.events.edit_title' : 'huseyinfiliz-pickem.admin.events.create_title');
  };
  _proto.content = function content() {
    var _this2 = this;
    var teams = app.store.all('pickem-teams');
    ...
    return m("div", {
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.events.week')), m((flarum_common_components_Select__WEBPACK_IMPORTED_MODULE_5___default()), {
      className: "FormControl",
      value: this.weekId,
      ...
      value: "0"
    }, app.translator.trans('huseyinfiliz-pickem.admin.events.no_week')))), m("div", {
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.events.home_team')), m((flarum_common_components_Select__WEBPACK_IMPORTED_MODULE_5___default()), {
      className: "FormControl",
      ...
      value: "0"
    }, app.translator.trans('huseyinfiliz-pickem.admin.events.select_team')))), m("div", {
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.events.away_team')), m((flarum_common_components_Select__WEBPACK_IMPORTED_MODULE_5___default()), {
      className: "FormControl",
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.events.match_date')), m("input", {
      className: "FormControl",
      type: "datetime-local",
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.events.cutoff_date')), m("input", {
      className: "FormControl",
      type: "datetime-local",
    ...
    }), app.translator.trans('huseyinfiliz-pickem.admin.events.allow_draw'))), m("div", {
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.events.status')), m((flarum_common_components_Select__WEBPACK_IMPORTED_MODULE_5___default()), {
      className: "FormControl",
      value: this.status,
      onchange: function onchange(value) {
        _this2.status = value;
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function (_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            app.alerts.show({
              type: 'error'
            }, app.translator.trans('huseyinfiliz-pickem.admin.validation.match_date_required'));
          ...
          case 1:
            ...
            app.alerts.show({
              type: 'error'
            }, app.translator.trans('huseyinfiliz-pickem.admin.validation.cutoff_date_required'));
            return _context.abrupt("return");
          case 2:
            ...
            app.alerts.show({
              type: 'error'
            }, app.translator.trans('huseyinfiliz-pickem.admin.validation.home_team_required'));
            return _context.abrupt("return");
          case 3:
            ...
            app.alerts.show({
              type: 'error'
            }, app.translator.trans('huseyinfiliz-pickem.admin.validation.away_team_required'));
            return _context.abrupt("return");
          case 4:
            ...
            app.alerts.show({
              type: 'error'
            }, app.translator.trans('huseyinfiliz-pickem.admin.validation.teams_must_differ'));
            return _context.abrupt("return");
          case 5:
            this.loading = true;
            m.redraw();
...
var ResultModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.content = function content() {
    ...
    if (this.homeScore !== '' && this.awayScore !== '') {
      if (home > away) resultText = homeTeam ? homeTeam.name() : 'Home Win';else if (away > home) resultText = awayTeam ? awayTeam.name() : 'Away Win';else resultText = app.translator.trans('huseyinfiliz-pickem.forum.picks.draw');
    }
    return m("div", {
      className: "Modal-body"
    }, m("div", {
      ...
      className: "Form-group"
    }, m("label", null, homeTeam ? homeTeam.name() : 'Home Team', " Score"), m("input", {
      className: "FormControl",
      type: "number",
      min: "0",
      ...
      className: "Form-group"
    }, m("label", null, awayTeam ? awayTeam.name() : 'Away Team', " Score"), m("input", {
      className: "FormControl",
      type: "number",
      min: "0",
      ...
      className: "Form-group"
    }, m("p", null, m("strong", null, "Result: "), resultText)), m("div", {
      className: "Form-group"
    }, m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_4___default()), {
      className: "Button Button--primary",
      type: "submit",
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function (_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            app.alerts.show({
              type: 'success'
            }, app.translator.trans('huseyinfiliz-pickem.admin.alerts.result_saved_success'));
          ...
          case 3:
            ...
            _t = _context["catch"](1);
            this.loading = false;
            this.alertAttrs = _t.alert; // Hata yönetimi
            m.redraw();
          case 4:
          case "end":
            return _context.stop();
...
var SeasonModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.title = function title() {
    return app.translator.trans(this.season ? 'huseyinfiliz-pickem.admin.seasons.edit_title' : 'huseyinfiliz-pickem.admin.seasons.create_title');
  };
  _proto.content = function content() {
    var _this2 = this;
    return m("div", {
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.seasons.name')), m("input", {
      className: "FormControl",
      type: "text",
      value: this.name,
      oninput: function oninput(e) {
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.seasons.slug')), m("input", {
      className: "FormControl",
      type: "text",
      value: this.slug,
      oninput: function oninput(e) {
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.seasons.start_date')), m("input", {
      className: "FormControl",
      type: "date",
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.seasons.end_date')), m("input", {
      className: "FormControl",
      type: "date",
      value: this.endDate,
      oninput: function oninput(e) {
...
// İçe aktarma yolu güncellendi (bir dizin yukarı çıktı)
var TeamModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.title = function title() {
    return app.translator.trans(this.team ? 'huseyinfiliz-pickem.admin.teams.edit_title' : 'huseyinfiliz-pickem.admin.teams.create_title');
  };
  _proto.content = function content() {
    var _this2 = this;
    return m("div", {
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.teams.name')), m("input", {
      className: "FormControl",
      type: "text",
      value: this.name,
      oninput: function oninput(e) {
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.teams.slug')), m("input", {
      className: "FormControl",
      type: "text",
      value: this.slug,
      oninput: function oninput(e) {
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.teams.logo_url')), m("input", {
      className: "FormControl",
      type: "text",
      value: this.logoPath,
      oninput: function oninput(e) {
...
var WeekModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.title = function title() {
    return app.translator.trans(this.week ? 'huseyinfiliz-pickem.admin.weeks.edit_title' : 'huseyinfiliz-pickem.admin.weeks.create_title');
  };
  _proto.content = function content() {
    var _this2 = this;
    var seasons = app.store.all('pickem-seasons');
    ...
    return m("div", {
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.weeks.name')), m("input", {
      className: "FormControl",
      type: "text",
      value: this.name,
      oninput: function oninput(e) {
      ...
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.weeks.season')), m((flarum_common_components_Select__WEBPACK_IMPORTED_MODULE_5___default()), {
      className: "FormControl",
      value: this.seasonId,
      onchange: function onchange(value) {
      ...
      value: "0"
    }, app.translator.trans('huseyinfiliz-pickem.admin.weeks.select_season')))), m("div", {
      className: "Form-group"
    }, m("label", null, app.translator.trans('huseyinfiliz-pickem.admin.weeks.week_number')), m("input", {
      className: "FormControl",
      type: "number",
